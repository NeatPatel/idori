...
function ThreeBlock(props) {
    ...
    const callbackFunction = ((entries) => {
        entries.forEach((entry) => {
            ...
            } else if(entry.target == rightBlockRef.current && props.animation) {
    ...
    return (<>
        <Row id={props.id} className={(props.animation ? styles.threeBlock : styles.topThreeBlock) + classesBlock}>
