    ...
    return (<>
                ...
                <Card className='bg-primary'>
                    <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                        ...
                        <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                            <h3>EarthHero</h3> 
                            <p>Earth Hero is an online marketplace that offers a wide selection of sustainable and eco-friendly products from various brands. They curate a range of items, including home goods, personal care products, and accessories, all with a focus on sustainability and reducing environmental impact. 
                            Earth Hero provides consumers with a convenient platform to find ethical and sustainable brands that offer high-quality products.</p>
        ...
        left = {<Card>
            <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                ...
                <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                    <h2>The Baby Penguin</h2> 
                    <p>The Baby Penguin is a dedicated platform empowering parents to make sustainable choices for their children. They curate a selection of the most sustainable toys that promote learning, development, and happiness. 
        ...
        middle = {
            ...
            <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                ...
                <div className="mx-auto p-lg-4 text-primary text-start">
                    <h2>Green Toys</h2>
                     <p>Green Toys is a brand that specializes in eco-friendly toys made from recycled plastic materials. Their toys are designed with sustainability in mind, prioritizing both environmental and child safety. 
                        Green Toys offers a wide range of imaginative and durable playthings that promote creative play while reducing waste and supporting a greener future.</p>
        ...
        right = {<Card className="text-center">
            <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                ...
                <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                    <h2>Plan Toys</h2> 
                    <p>Plan Toys is a renowned brand known for their sustainable and educational wooden toys. They use eco-friendly materials, such as rubberwood, and their manufacturing process follows strict environmental standards. Plan Toys offers a diverse range of toys that foster creativity, imagination, and early childhood development, while also promoting a commitment to sustainability and natural play.</p>
        ...
        <TripleBlock animation={true} mb = "5"
            ...
            middle = {
                ...
                <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                    ...
                    <div className="mx-auto p-lg-4 text-primary text-start">
                        <h2>Seventh Generation</h2> 
                        <p>Seventh Generation is a leading brand in sustainable household and personal care products. With a commitment to environmental responsibility, their products are made from plant-based ingredients, free from harmful chemicals, and packaged in recycled materials. Seventh Generation strives to create a healthier and more sustainable future for both people and the planet.</p>
            ...
            left = {<Card>
                <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                    ...
                    <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                        <h2>Earth Brands</h2> 
                        <p>Earth Brands is a company that specializes in manufacturing 100% compostable PLA cups. Their products are designed to reduce waste and environmental impact, providing an eco-friendly alternative to traditional plastic cups. Earth Brands offers a convenient and environmentally conscious solution for individuals and businesses seeking sustainable options for their disposable cup needs.</p>
            ...
            middle = {
                ...
                <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                    ...
                    <div className="mx-auto p-lg-4 text-primary text-start">
                        <h2>Pela Case</h2> 
                        <p>Pela Case is a leading brand in sustainable phone cases, committed to reducing plastic waste and promoting eco-friendly alternatives. Their phone cases are made from innovative and durable materials, such as Flaxstic®, which combines plant-based biopolymers and flax straw fibers. Pela Case offers stylish and protective phone cases that are 100% compostable, allowing consumers to make a positive impact on the environment without compromising on style or functionality.</p>
        ...
        <TripleBlock animation={true} mb = "5"
            left = {<Card>
                <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                    ...
                    <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                        <h2>Patagonia</h2> 
                        <p>Patagonia is a renowned outdoor clothing and gear company that is committed to environmental and social responsibility. They prioritize sustainability by using recycled and organic materials in their products and actively work to reduce their carbon footprint. Patagonia's mission extends beyond selling outdoor gear; they are dedicated to protecting the planet and supporting environmental activism through their initiatives and campaigns.</p>
            ...
            right = {<Card className="text-center">
                <div className={styles.innerCard + "p-md-2 p-1 bg-info"}>
                    ...
                    <div className="mx-auto p-lg-4 p-md-2 p-1 bg-info text-primary text-start">
                        <h2>Pact</h2> 
                        <p>Pact is an apparel brand that focuses on creating sustainable and organic clothing for men, women, and children. They use Fair Trade Certified factories and organic materials, ensuring that their products are produced ethically and with minimal environmental impact. Pact offers a range of comfortable and stylish clothing options, all while maintaining a commitment to sustainability and social responsibility.</p>
